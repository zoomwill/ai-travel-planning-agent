...
_METRIC_NAMES = (
    ...
    "travel_planner_intake_turns_total",
    "travel_planner_intake_turn_duration_seconds",
    "travel_planner_intake_confirmations_total",
    "travel_planner_intake_clarifications_total",
    "travel_planner_external_requests_total",
    "travel_planner_external_request_duration_seconds",
    "travel_planner_search_source_total",
)
...
def check_grafana_dashboard(grafana_url: str, fetcher: Fetcher = fetch) -> CheckResult:
    """Verify the provisioned dashboard UID and its required 32 panels."""
    ...
    valid = dashboard.get("uid") == uid and len(panels) == 32
    return CheckResult(
        "Grafana dashboard",
        valid,
